...
const FALLBACK_PUPPIES: Puppy[] = [
  ...
  { id: 5, name: "Oscar", ageWeeks: 7, color: "bleu merle", sex: "Mâle", price: 1900, description: "Oscar est le petit clown de la portée. Il est toujours prêt à faire des bêtises pour attirer l'attention.", traits: ["Rigolo", "Sociable", "Actif"], parents: "Luna (Bleu Merle) x Orion (Noir Tricolore)", images: ["/images/puppy-bleu-merle.png"], status: "available", isPremium: false, createdAt: new Date().toISOString() },
  { id: 6, name: "Bella", ageWeeks: 8, color: "rouge merle", sex: "Femelle", price: 2200, description: "Bella a des yeux vairons magnifiques. Elle est très proche de l'homme et demande beaucoup de tendresse.", traits: ["Proche de l'homme", "Tendre", "Observatrice"], parents: "Stella (Rouge Merle) x Orion (Noir Tricolore)", images: ["/images/puppy-rouge-merle.png"], status: "available", isPremium: false, createdAt: new Date().toISOString() },
];
